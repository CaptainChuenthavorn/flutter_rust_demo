...
#[wasm_bindgen]
pub fn wire_get_token(port_: flutter_rust_bridge::for_generated::MessagePort, input: String) {
...
#[wasm_bindgen]
pub fn wire_hello(port_: flutter_rust_bridge::for_generated::MessagePort, a: String) {
