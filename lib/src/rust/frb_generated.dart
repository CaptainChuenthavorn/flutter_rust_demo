...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<List<String>> getToken({required String input, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        return wire.wire_get_token(port_, arg0);
      },
      codec: DcoCodec(
  ...
  Future<String> myRustFunction({required String a, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        var arg0 = cst_encode_String(a);
        return wire.wire_my_rust_function(port_, arg0);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_String,
        decodeErrorData: null,
      ),
      constMeta: kMyRustFunctionConstMeta,
      argValues: [a],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kMyRustFunctionConstMeta => const TaskConstMeta(
        debugName: "my_rust_function",
        argNames: ["a"],
      );
